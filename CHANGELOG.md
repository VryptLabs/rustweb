...
Stable VDOM diff + hydration, router, CLI, testing, and benchmark/a11y
harnesses — all exit criteria satisfied. See `docs/src/release-v1.md`.
No API changes since `1.0.0-rc.1`.
